# Initiator Refactoring: Proc Macro Implementation

## Overview

Refactored the WebAssembly Component Initiator from a feature-flag-based system to a declarative proc macro system. This change significantly improves code maintainability, readability, and flexibility.
...
- Initiator infrastructure now generated by the macro
...
This refactoring significantly improves the developer experience when working with the WebAssembly Component Initiator. The declarative approach makes configurations more readable, maintainable, and less error-prone while reducing boilerplate by over 70%.
