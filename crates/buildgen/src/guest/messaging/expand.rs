...
pub fn expand(generated: Generated) -> TokenStream {
    let http_guest = generated.http.map(expand_http);
    let messaging_guest = generated.messaging.map(expand_messaging);
...
fn expand_http(http: HttpGuest) -> TokenStream {
...
fn expand_messaging(messaging: MessagingGuest) -> TokenStream {
